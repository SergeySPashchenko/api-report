...
final class SecureSellerService
{
     ...
     * @throws Exception
     */
    public function getExpenses(?string $date_start = null, ?string $date_end = null): array
    {
        $data = [];
        ...
        $response = $this->makeRequest('getExpenses', $data);
     ...
     * @throws Exception
     */
    public function getOrders(?string $date_start = null, ?string $date_end = null): array
    {
        $data = [];
        ...
        $response = $this->makeRequest('getOrders', $data);
